...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference('Submission.count') do
      post submissions_url, params: { submission: { age: @submission.age, date_of_birth: @submission.date_of_birth, name: @submission.name } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { age: @submission.age, date_of_birth: @submission.date_of_birth, name: @submission.name } }
